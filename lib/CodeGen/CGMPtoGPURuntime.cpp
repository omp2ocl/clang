...
CGMPtoGPURuntime::CreateRuntimeFunction(MPtoGPURTLFunction Function) {
  ...
  case MPtoGPURTL_get_num_cores: {
    ...
    llvm::Type *TParams[] = {CGM.Int32Ty, CGM.Int32Ty, CGM.Int32Ty,
                             CGM.Int32Ty};
    llvm::FunctionType *FnTy =
  ...
  case MPtoGPURTL_cl_execute_kernel: {
    // Build int _cl_execute_kernel(long size1, long size2, long size3, int
    // dim);
  ...
  case MPtoGPURTL_cl_execute_tiled_kernel: {
    // Build int _cl_execute_tiled_kernel(int wsize0, int wsize1, int wsize2,
    // int block0, int block1, int block2, int dim);
...
llvm::Value *CGMPtoGPURuntime::cldevice_init() {
  return CGM.CreateRuntimeFunction(
      llvm::TypeBuilder<_cldevice_init, false>::get(CGM.getLLVMContext()),
      "_cldevice_init");
}

llvm::Value *CGMPtoGPURuntime::cldevice_finish() {
  return CGM.CreateRuntimeFunction(
      llvm::TypeBuilder<_cldevice_finish, false>::get(CGM.getLLVMContext()),
      "_cldevice_finish");
}

llvm::Value *CGMPtoGPURuntime::Set_default_device() {
  return CGM.CreateRuntimeFunction(
      llvm::TypeBuilder<_set_default_device, false>::get(CGM.getLLVMContext()),
      "_set_default_device");
}

llvm::Value *CGMPtoGPURuntime::Get_num_devices() {
  return CGM.CreateRuntimeFunction(
      llvm::TypeBuilder<_get_num_devices, false>::get(CGM.getLLVMContext()),
      "_get_num_devices");
}

llvm::Value *CGMPtoGPURuntime::Get_num_cores() {
  return CGM.CreateRuntimeFunction(
      llvm::TypeBuilder<_get_num_cores, false>::get(CGM.getLLVMContext()),
      "_get_num_cores");
}

llvm::Value *CGMPtoGPURuntime::Get_default_device() {
  return CGM.CreateRuntimeFunction(
      llvm::TypeBuilder<_get_default_device, false>::get(CGM.getLLVMContext()),
      "_get_default_device");
}

llvm::Value *CGMPtoGPURuntime::cl_create_read_only() {
  return CGM.CreateRuntimeFunction(
      llvm::TypeBuilder<_cl_create_read_only, false>::get(CGM.getLLVMContext()),
      "_cl_create_read_only");
}

llvm::Value *CGMPtoGPURuntime::cl_create_write_only() {
  return CGM.CreateRuntimeFunction(
      llvm::TypeBuilder<_cl_create_write_only, false>::get(
          CGM.getLLVMContext()),
      "_cl_create_write_only");
}

llvm::Value *CGMPtoGPURuntime::cl_offloading_read_only() {
  return CGM.CreateRuntimeFunction(
      llvm::TypeBuilder<_cl_offloading_read_only, false>::get(
          CGM.getLLVMContext()),
      "_cl_offloading_read_only");
}

llvm::Value *CGMPtoGPURuntime::cl_offloading_write_only() {
  return CGM.CreateRuntimeFunction(
      llvm::TypeBuilder<_cl_offloading_read_only, false>::get(
          CGM.getLLVMContext()),
...
llvm::Value *CGMPtoGPURuntime::cl_create_read_write() {
  return CGM.CreateRuntimeFunction(
      llvm::TypeBuilder<_cl_create_read_write, false>::get(
          CGM.getLLVMContext()),
      "_cl_create_read_write");
}

llvm::Value *CGMPtoGPURuntime::cl_offloading_read_write() {
  return CGM.CreateRuntimeFunction(
      llvm::TypeBuilder<_cl_offloading_read_write, false>::get(
          CGM.getLLVMContext()),
      "_cl_offloading_read_write");
}

llvm::Value *CGMPtoGPURuntime::cl_read_buffer() {
  return CGM.CreateRuntimeFunction(
      llvm::TypeBuilder<_cl_read_buffer, false>::get(CGM.getLLVMContext()),
      "_cl_read_buffer");
}

llvm::Value *CGMPtoGPURuntime::cl_write_buffer() {
  return CGM.CreateRuntimeFunction(
      llvm::TypeBuilder<_cl_write_buffer, false>::get(CGM.getLLVMContext()),
      "_cl_write_buffer");
}

llvm::Value *CGMPtoGPURuntime::cl_create_program() {
  return CGM.CreateRuntimeFunction(
      llvm::TypeBuilder<_cl_create_program, false>::get(CGM.getLLVMContext()),
      "_cl_create_program");
}

llvm::Value *CGMPtoGPURuntime::cl_create_kernel() {
  return CGM.CreateRuntimeFunction(
      llvm::TypeBuilder<_cl_create_kernel, false>::get(CGM.getLLVMContext()),
      "_cl_create_kernel");
}

llvm::Value *CGMPtoGPURuntime::cl_set_kernel_args() {
  return CGM.CreateRuntimeFunction(
      llvm::TypeBuilder<_cl_set_kernel_args, false>::get(CGM.getLLVMContext()),
      "_cl_set_kernel_args");
}

llvm::Value *CGMPtoGPURuntime::cl_set_kernel_arg() {
  return CGM.CreateRuntimeFunction(
      llvm::TypeBuilder<_cl_set_kernel_arg, false>::get(CGM.getLLVMContext()),
      "_cl_set_kernel_arg");
}

llvm::Value *CGMPtoGPURuntime::cl_set_kernel_hostArg() {
  return CGM.CreateRuntimeFunction(
      llvm::TypeBuilder<_cl_set_kernel_hostArg, false>::get(
          CGM.getLLVMContext()),
      "_cl_set_kernel_hostArg");
}

llvm::Value *CGMPtoGPURuntime::cl_execute_kernel() {
  return CGM.CreateRuntimeFunction(
      llvm::TypeBuilder<_cl_execute_kernel, false>::get(CGM.getLLVMContext()),
      "_cl_execute_kernel");
}

llvm::Value *CGMPtoGPURuntime::cl_execute_tiled_kernel() {
  return CGM.CreateRuntimeFunction(
      llvm::TypeBuilder<_cl_execute_tiled_kernel, false>::get(
          CGM.getLLVMContext()),
      "_cl_execute_tiled_kernel");
}

llvm::Value *CGMPtoGPURuntime::cl_release_buffers() {
  return CGM.CreateRuntimeFunction(
      llvm::TypeBuilder<_cl_release_buffers, false>::get(CGM.getLLVMContext()),
      "_cl_release_buffers");
}

llvm::Value *CGMPtoGPURuntime::cl_release_buffer() {
  return CGM.CreateRuntimeFunction(
      llvm::TypeBuilder<_cl_release_buffer, false>::get(CGM.getLLVMContext()),
      "_cl_release_buffer");
}

llvm::Value *CGMPtoGPURuntime::cl_get_threads_blocks() {
  return CGM.CreateRuntimeFunction(
      llvm::TypeBuilder<_cl_get_threads_blocks, false>::get(
          CGM.getLLVMContext()),
